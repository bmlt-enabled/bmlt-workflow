    ...
    <div class="form-grid">
        ...
        <div class="form-grid-col1">
            ...
            <label for="quickedit_formatIds"><?php echo __( "Meeting Formats", 'bmlt-workflow' ); ?>
                ...
                <label for="quickedit_comments"><?php echo __( "Meeting Comments (Publically displayed)", 'bmlt-workflow' ); ?></label>
                <div class="grow-wrap">
                    <textarea class="dialog_textarea quickedit-input" id="quickedit_comments" name="quickedit_comments" onInput="this.parentNode.dataset.replicatedValue = this.value"></textarea>
                </div>
            </div>
        <div class="form-grid-col2">
            ...
            <div id="optional_location_nation">
                <label id="quickedit_location_nation_label" for="quickedit_location_nation"><?php echo sanitize_text_field(get_option('bmltwf_optional_location_nation_displayname')) ?></label>
