...
<div id="wbw_bmlt_configuration_dialog" class="hidden" style="max-width:800px">
    ...
    <input type="url" size="50" id="wbw_bmlt_server_address" name="wbw_bmlt_server_address" value="<?php echo $wbw_bmlt_username ?>" />
    <br><label for="wbw_bmlt_username"><b>BMLT Username:</b></label>
    <input type="text" size="50" id="wbw_bmlt_username" name="wbw_bmlt_username" value="<?php echo $wbw_bmlt_username ?>" />
