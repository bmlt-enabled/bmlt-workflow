...
class Controller extends \WP_REST_Controller
{
	...
	public function __construct($stub = null)
	{
		if(!$stub)
		{
			$this->debug_log("Creating new BMLTServerHandler");
			$this->BMLTServerHandler = new BMLTServerHandler();
			$this->debug_log("Creating new ServiceBodiesHandler");
			$this->ServiceBodiesHandler = new ServiceBodiesHandler();
			$this->debug_log("Creating new SubmissionsHandler");
			$this->SubmissionsHandler = new SubmissionsHandler();
			$this->debug_log("Creating new OptionsHandler");
