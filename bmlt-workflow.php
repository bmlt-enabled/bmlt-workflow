        ...
        public function bmltwf_admin_scripts($hook)
        {
            ...
            switch ($hook) {
                ...
                case ('bmlt-workflow_page_bmltwf-submissions'):
                    ...
                    // datatables
                    wp_register_style('dtcss', plugin_dir_url(__FILE__) . '/thirdparty/css/dt/dt-1.11.5/b-2.2.2/r-2.2.9/sl-1.3.4/datatables.min.css', false, '1.0', 'all');
                    wp_register_script('dt', plugin_dir_url(__FILE__) . '/thirdparty/js/dt/dt-1.11.5/b-2.2.2/r-2.2.9/sl-1.3.4/datatables.min.js', array('jquery'), '1.0', true);
